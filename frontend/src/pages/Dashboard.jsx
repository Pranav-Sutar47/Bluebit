...
//       case 'patients': return renderPatientsContent();
...
//               link={{
//                 label: "Logout",
//                 icon: <svg xmlns="http://www.w3.org/2000/svg" className="text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
