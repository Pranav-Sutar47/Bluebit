...
const DoctorDashboard = () => {
  ...
  const renderDashboardContent = () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
      <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
        {['Patient Intake', 'E-Prescriptions', 'Billing'].map((title, index) => (
          <div 
            key={index} 
  ...
  const renderContent = () => {
    switch(activeTab) {
      ...
      case 'patients': return <PatientsComponent />;
      case 'consultations': return <ConsultationsComponent />;
      default: return <div className="p-6">Coming Soon</div>;
    }
  };

  // Using a consistent gradient for both sidebar header and main header
  const gradientClass = "bg-gradient-to-r from-blue-600 to-cyan-500";

  return (
    <div className="flex h-screen to-blue-600 bg-gray-50">
      <Sidebar isHovered={isHovered} setIsHovered={setIsHovered}>
        <div className="flex flex-col h-full">
          {/* Sidebar header with matching gradient background */}
          <div className={`bg-blue-600 p-5 flex justify-center items-center text-white`}>
            <h2 className={`
          ...
          <div className="p-4 border-t space-y-2">
            ...
            <SidebarLink
              ...
              link={{
                label: "Logout",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className={`${gradientClass} p-4 flex justify-between items-center`}>
